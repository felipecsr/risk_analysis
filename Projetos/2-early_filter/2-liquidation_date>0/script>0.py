...
output_path = './result/early_median_result-liquidation-date.csv'
...
# Consulta SQL para realizar o JOIN e aplicar filtros
query = """
    SELECT 
        t.id AS id_transfer,
        t.liquidation_date,
    ...
    ON 
        t.contract_id = c.id
    WHERE 
        c.early_termination_penalty > 0 AND
        t.liquidation_date > 0
"""
